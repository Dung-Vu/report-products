window.impactEvidence = {
    ...
    companyScale: [
        {
            ...
            label: "Tra giá & tra tồn",
            value: 1837,
            unit: "interactions",
            display: "1,837",
            description:
                "Lượt nhân viên dùng Price Lookup và Stock Onhand để phản hồi khách nhanh hơn, giảm hỏi tay giữa Sales, SC và kho.",
            source: "Log tra cứu + traffic web · kiểm tra 15/05/2026",
            confidence: "verified",
        },
        {
            id: "fabric-calculator-usage",
            label: "Tính vải sản xuất",
            value: 250,
            unit: "requests",
            display: "250",
            description:
                "Lượt dùng công cụ tính vải rèm và xuất layout sản xuất, thay cho nhiều bước tính tay từ file báo giá.",
            source: "Traffic web + log ứng dụng · kiểm tra 15/05/2026",
            confidence: "verified",
        },
        {
            id: "runtime-stability",
            label: "ROI tổng 11 project",
            value: 860,
            unit: "percent",
            display: "+860%",
            description:
                "Tính từ tổng lợi nhuận ròng khoảng 150tr+ so với phần chi phí đã quy đổi rõ khoảng 17,45tr ở các project có số cost cụ thể.",
    ...
    repoRelevantOdoo: [
        {
            id: "products-created",
            label: "Dữ liệu sản phẩm đã xử lý",
            value: 16000,
            unit: "records",
            display: "~16.000",
            description: "Từ project Tạo sản phẩm Odoo: đồng bộ và clean dữ liệu Bonario từ nguồn thô của Arte, Acacia và các nhà cung cấp khác để đưa vào Odoo.",
        ...
        },
        {
            ...
            unit: "records",
            display: "3,540",
            description: "Công thức sản xuất được tạo mới, giúp sản phẩm có cấu thành rõ hơn cho SC, kho và kế toán.",
            source: "Đếm trực tiếp từ Odoo · kiểm tra 15/05/2026",
            confidence: "verified",
        },
        {
            id: "vendor-bills",
            label: "Chứng từ VAT đã xử lý",
            value: 983,
            unit: "records",
            display: "983",
            description: "Từ project Bills Archive Server: xử lý chứng từ VAT trong 4 tháng, rút khối lượng thủ công khoảng 1 tháng xuống còn 1 buổi triển khai.",
